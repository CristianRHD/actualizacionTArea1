...
import { IMCCALCULATORComponent } from './component/imccalculator/imccalculator.component';


@Component({
  selector: 'app-root',
  imports: [RouterOutlet,FormsModule,CommonModule,IMCCALCULATORComponent],
